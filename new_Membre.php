    ...
    <main>
      ...
      <form method="POST">
        <div>
          ...
          <input type="text" name="prenom" id="prenom" value="<?php if ($f->isSubmitted()) {
        ...
        <div>
          ...
          <input type="text" name="nom" id="nom" value="<?php if ($f->isSubmitted()) {
                                                          if (!empty($_POST["nom"])) {
                                                            echo $_POST["nom"];
                                                          }
                                                        } ?>">
        ...
        <div>
          ...
          <input type="email" name="email" id="email" value="<?php if ($f->isSubmitted()) {
